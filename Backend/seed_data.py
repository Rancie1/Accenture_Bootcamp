...
def seed_demo_users(db: Session) -> list[str]:
    ...
    demo_users = [
        ...
        {
            "user_id": "usr_ljames_legend_000",
            "name": "L. James",
            "weekly_budget": 1000.00,
            "home_address": "Legend Street, Sydney NSW 2000",
        },
        {
...
def seed_weekly_plans(db: Session, user_ids: list[str]) -> None:
    ...
    budgets = [1000.00, 180.00, 150.00, 200.00, 120.00, 160.00, 140.00, 175.00, 130.00, 190.00, 155.00,
    ...
    plans = [
        # L. James - Legendary (avg score ~0.999)
        (0, 1.00, 1.00),      # score = (1000-1)/1000 = 0.999
        (0, 1.00, 1.00),      # score = (1000-1)/1000 = 0.999
        (0, 1.00, 1.00),      # score = (1000-1)/1000 = 0.999
        
        # Alice - Top performer (avg score ~0.35)
        (1, 80.00, 115.00),   # score = (180-115)/180 = 0.361
        (1, 75.00, 120.00),   # score = (180-120)/180 = 0.333
        (1, 85.00, 118.00),   # score = (180-118)/180 = 0.344
        
        # Bob - Excellent (avg score ~0.28)
        (2, 70.00, 108.00),   # score = (150-108)/150 = 0.280
        (2, 65.00, 105.00),   # score = (150-105)/150 = 0.300
        (2, 72.00, 112.00),   # score = (150-112)/150 = 0.253
        
        # Charlie - Very Good (avg score ~0.20)
        (3, 90.00, 160.00),   # score = (200-160)/200 = 0.200
        (3, 88.00, 158.00),   # score = (200-158)/200 = 0.210
        (3, 85.00, 162.00),   # score = (200-162)/200 = 0.190
        
        # Diana - Good (avg score ~0.10)
        (4, 55.00, 108.00),   # score = (120-108)/120 = 0.100
        (4, 60.00, 110.00),   # score = (120-110)/120 = 0.083
        (4, 58.00, 106.00),   # score = (120-106)/120 = 0.117
        
        # Evan - Above Average (avg score ~0.15)
        (5, 68.00, 136.00),   # score = (160-136)/160 = 0.150
        (5, 72.00, 138.00),   # score = (160-138)/160 = 0.138
        (5, 70.00, 134.00),   # score = (160-134)/160 = 0.163
        
        # Fiona - Strong (avg score ~0.25)
        (6, 60.00, 105.00),   # score = (140-105)/140 = 0.250
        (6, 62.00, 108.00),   # score = (140-108)/140 = 0.229
        (6, 58.00, 102.00),   # score = (140-102)/140 = 0.271
        
        # George - Excellent (avg score ~0.30)
        (7, 75.00, 122.50),   # score = (175-122.5)/175 = 0.300
        (7, 78.00, 125.00),   # score = (175-125)/175 = 0.286
        (7, 72.00, 120.00),   # score = (175-120)/175 = 0.314
        
        # Hannah - Average (avg score ~0.18)
        (8, 58.00, 106.60),   # score = (130-106.6)/130 = 0.180
        (8, 60.00, 108.00),   # score = (130-108)/130 = 0.169
        (8, 56.00, 104.00),   # score = (130-104)/130 = 0.200
        
        # Isaac - Top Tier (avg score ~0.32)
        (9, 85.00, 129.20),   # score = (190-129.2)/190 = 0.320
        (9, 88.00, 132.00),   # score = (190-132)/190 = 0.305
        (9, 82.00, 126.00),   # score = (190-126)/190 = 0.337
        
        # Julia - Good (avg score ~0.22)
        (10, 68.00, 120.90),   # score = (155-120.9)/155 = 0.220
        (10, 70.00, 122.00),   # score = (155-122)/155 = 0.213
        (10, 65.00, 118.00),   # score = (155-118)/155 = 0.239
        
        # Kevin - Strong (avg score ~0.24)
        (11, 72.00, 125.40),  # score = (165-125.4)/165 = 0.240
        (11, 75.00, 128.00),  # score = (165-128)/165 = 0.224
        (11, 70.00, 122.00),  # score = (165-122)/165 = 0.261
        
        # Lily - Above Average (avg score ~0.19)
        (12, 63.00, 117.45),  # score = (145-117.45)/145 = 0.190
        (12, 65.00, 119.00),  # score = (145-119)/145 = 0.179
        (12, 60.00, 115.00),  # score = (145-115)/145 = 0.207
        
        # Marcus - Very Strong (avg score ~0.29)
        (13, 82.00, 131.35),  # score = (185-131.35)/185 = 0.290
        (13, 85.00, 134.00),  # score = (185-134)/185 = 0.276
        (13, 80.00, 128.00),  # score = (185-128)/185 = 0.308
        
        # Nina - Moderate (avg score ~0.12)
        (14, 55.00, 110.00),  # score = (125-110)/125 = 0.120
        (14, 58.00, 112.00),  # score = (125-112)/125 = 0.104
        (14, 52.00, 108.00),  # score = (125-108)/125 = 0.136
        
        # Oliver - Strong (avg score ~0.26)
        (15, 75.00, 125.80),  # score = (170-125.8)/170 = 0.260
        (15, 78.00, 128.00),  # score = (170-128)/170 = 0.247
        (15, 72.00, 122.00),  # score = (170-122)/170 = 0.282
        
        # Priya - Average (avg score ~0.16)
        (16, 60.00, 113.40),  # score = (135-113.4)/135 = 0.160
        (16, 62.00, 115.00),  # score = (135-115)/135 = 0.148
        (16, 58.00, 111.00),  # score = (135-111)/135 = 0.178
        
        # Quinn - Top Performer (avg score ~0.33)
        (17, 88.00, 130.65),  # score = (195-130.65)/195 = 0.330
        (17, 90.00, 133.00),  # score = (195-133)/195 = 0.318
        (17, 85.00, 127.00),  # score = (195-127)/195 = 0.349
        
        # Rachel - Good (avg score ~0.21)
        (18, 68.00, 118.50),  # score = (150-118.5)/150 = 0.210
        (18, 70.00, 120.00),  # score = (150-120)/150 = 0.200
        (18, 65.00, 116.00),  # score = (150-116)/150 = 0.227
        
        # Sam - Above Average (avg score ~0.17)
        (19, 70.00, 132.80),  # score = (160-132.8)/160 = 0.170
        (19, 72.00, 134.00),  # score = (160-134)/160 = 0.163
        (19, 68.00, 131.00),  # score = (160-131)/160 = 0.181
        
        # Tina - Average (avg score ~0.14)
        (20, 62.00, 120.40),  # score = (140-120.4)/140 = 0.140
        (20, 65.00, 122.00),  # score = (140-122)/140 = 0.129
        (20, 60.00, 118.00),  # score = (140-118)/140 = 0.157
    ]
