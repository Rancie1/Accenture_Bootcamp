...
const Shop = () => {
  ...
  const { level, defaultItems, setDefaultItems, shoppingList, setShoppingList } = useContext(AppContext);
  ...
  /**
   * Clear shopping list and navigate to edit list page
   * Requirement 2.8: Display "Start a new list" button
   */
          ...
          {defaultItems.map(item => (
            ...
            >
              <div
                ...
                className="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-md active:scale-95 transition-transform cursor-pointer"
              >
